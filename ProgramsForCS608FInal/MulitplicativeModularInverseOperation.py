...
# This prime function isn't used anymore and is just obsolete but I left it here for completeness
def prime(a):
    if a < 2: return False
...
def MultiplicativeModularInverseOperation(number_to_be_inverted, modulus):
    ...
    if gcd == 1:
        ...
        if verify:
            # This part actually never runs anymore. It was slow during the Midterm so I just removed it.
...
mod = 23           # 8348
# number = 23
# mod = 1000000007   # 739130440
# number = 13
# mod = 26          # doesn't exist
#number = 7
#mod = 8            # 7

modinv = MultiplicativeModularInverseOperation(number, mod)
#print(modinv)
